  ...
  return (
    <>
      ...
      >
        ...
        <form onSubmit={onSubmit} className="max-w-2xl  text-gray-600 pt-8">
          ...
          <button className="bg-blue-600 cursor-pointer hover:bg-blue-800 text-white py-2 px-12 mb-10 rounded">
